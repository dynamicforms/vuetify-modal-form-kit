...
- `VuetifyInputsComponentBuilder.dfImage(props)`, typed to `DfInputComponentProps.DfImageProps`, for the
  `df-image` component `@dynamicforms/vuetify-inputs` 0.10.1 adds. The peer dependency moves to `^0.10.1`.
...
- The peer dependency moves to `@dynamicforms/vuetify-inputs` `^0.10.0`.
